...
const questions = [
  ...
  },
  {
    ...
    theme: 'red',
    options: [
      { value: 'yes', label: 'Yes, lets move mountains together', color: 'bg-gradient-to-r from-patriot-red to-patriot-crimson' },
      { value: 'discuss', label: 'Lets discuss further', color: 'bg-gradient-to-r from-patriot-blue to-patriot-navy' }
    ]
  }
];
